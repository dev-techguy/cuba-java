...
public class SessionBrowse extends StandardLookup<Session> {
    ...
    @Subscribe("sessionCalender")
    public void onSessionCalenderCalendarEventClick(Calendar.CalendarEventClickEvent<LocalDateTime> event) {
        sessionEditDialog.setEntityProvider(() -> (Session) event.getEntity());
        sessionEditDialog.show();
    }

    @Subscribe("sessionCalender")
    public void onSessionCalenderCalendarEventMove(Calendar.CalendarEventMoveEvent<LocalDateTime> event) {
